                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse Items" id="navbarSupportedContent">
                                ...
                                <div>
                                        ...
                                        <a href="../Customer/Login/registration.php" class="btn btn-primary float-right" style="width: 100px;margin-right: 20px;"><span>Join</span></a>
                                        <a href="../Customer/Login/login.php" class="btn btn-primary float-right" style="width: 100px;margin-right: 20px;"><span>Login</span></a>
                                    </div>
