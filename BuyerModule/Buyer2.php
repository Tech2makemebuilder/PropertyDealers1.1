                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="padding: 1px 0 1px 0; ">
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse Items" id="navbarSupportedContent">
                                ...
                                <div class="dropdown">
  <button class="btn btn-secondary dropdown-toggle" style="margin-right: 100px;" type="button" id="user" data-bs-toggle="dropdown" aria-expanded="false">
  <i style="color: white;margin-right: 20px;"  class="fa fa-user-circle"></i></button> 
  <ul style="width: 50px;" class="dropdown-menu" aria-labelledby="user">
    <li><a class="dropdown-item" href="#">My Account</a></li>
    <li><a class="dropdown-item" href="../Buyer Module/Buyer.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Log out</a></li>
  </ul>
</div>
